...
function Projects () {
    const projects = [
        ...
        },
        {
            ...
            Para aprovechar las funcionalidades de React en un sitio web, añadí ...`,
    ...
    return (
        <div className='px-20 py-10'>
            ...
            <div className='w-full flex flex-col gap-3 justify-center items-center'>
                {projects.map(({img, title, description, techs}) => 
                    <Project img={img} title={title} description={description} techs={techs} />
                )}
            </div>  
        </div>
    )
